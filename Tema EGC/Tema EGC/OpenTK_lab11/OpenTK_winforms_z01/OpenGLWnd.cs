...
namespace OpenTK_winforms_z01 {
    public partial class OpenGLWnd : Form {
        ...
        private bool cubControl = false;

        private bool translateTriangleControl = false;
        private int translateTriangleVal = 0;
        private bool translateCubControl = false;
        private float translateCubValZ = 0f;
        private float translateCubValX = 0f;

        private bool scaleCub = false;
        private bool rotateCub = false;

        private Piramida cub = new Piramida();
        ...
        private void glControlDemo_Paint(object sender, PaintEventArgs e) {
            ...
            if(cubControl)
            {
                ...
                {
                    GL.Translate(-0.1f + translateCubValX, 0, 0);
                    cub.DrawTriangle();
                    translateCubValX -= 0.1f;
                }
                if (keyboard.IsKeyDown(Key.A))
                {
                    GL.Translate(0, 0, 0.1f + translateCubValZ);
                    cub.DrawTriangle();
                    translateCubValZ += 0.1f;
                }
        ...
        private void glControlDemo_MouseMove(object sender, System.Windows.Forms.MouseEventArgs e) {
        ...
        private void cubButon_Click(object sender, EventArgs e)
        {
            cubControl = !cubControl;
        }

        private void scalareCub_Click(object sender, EventArgs e)
        {
            scaleCub = !scaleCub;
        }

        private void rotireCub_Click(object sender, EventArgs e)
        {
            rotateCub = !rotateCub;
        }
    }
