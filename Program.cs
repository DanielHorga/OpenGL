...
namespace oda
{
    internal class Program : GameWindow
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            Console.Write("\nESC");
            Console.ResetColor();
            Console.WriteLine(" Inchide programul");
        }
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
            ...
            else if (keyboard.IsKeyDown(OpenTK.Input.Key.AltLeft) && keyboard.IsKeyDown(OpenTK.Input.Key.D) && !keyboard.Equals(lastKeyPress))
            {
                if (showCube == true)
                {
                    showCube = false;
